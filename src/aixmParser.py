...
def syntaxe():
    ...
    print("    " + aixmReader.CONST.optGeojsonDigitOptimize + "  Integer parameter for optimize Geojson output geometry coordinates (Default=6 digits, n for round(coords, n), sample=10")
    print("    " + aixmReader.CONST.optOpenairDigitOptimize + "  Integer parameter for optimize Openair output geometry coordinates (Default=-1 no-change source, n for round(coords, n), sample=0")
    print("    " + aixmReader.CONST.optEpsilonReduce + "  Float parameter of Ramer-Douglas-Peucker Algorithm (https://github.com/fhirschmann/rdp) for optimize output (Default=-1: <0 for no-optimize; 0 for removal-duplicates-values and no-optimize; >0 for optimize, sample=0.002)")
    ...
    print("           " + __AppName__ + " ../tst/aixm4.5_SIA-FR_2020-04-23.xml " + aixmReader.CONST.frmtGEOJSON + " " + aixmReader.CONST.typeAIRSPACES + " " + aixmReader.CONST.optFreeFlight + " " + aixmReader.CONST.optGeojsonDigitOptimize + "=10" + " " + aixmReader.CONST.optCleanLog)
    print("           " + __AppName__ + " ../tst/aixm4.5_SIA-FR_2020-04-23.xml " + aixmReader.CONST.frmtOPENAIR + " " + aixmReader.CONST.typeAIRSPACES + " " + aixmReader.CONST.optFreeFlight + " " + aixmReader.CONST.optOpenairDigitOptimize + "=0" + " " + aixmReader.CONST.optCleanLog)
    print("           " + __AppName__ + " ../tst/aixm4.5_SIA-FR_2020-04-23.xml " + aixmReader.CONST.frmtALL + " " + aixmReader.CONST.typeAIRSPACES + " " + aixmReader.CONST.optFreeFlight + " " + aixmReader.CONST.optOpenairDigitOptimize + "=0 " + aixmReader.CONST.optEpsilonReduce + "=0.002 " + aixmReader.CONST.optCleanLog)
    print("")
    print("  Resources")
