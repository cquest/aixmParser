...
def syntaxe():
    ...
    print("    " + aixmReader.CONST.optEpsilonReduce + "  Float parameter of Ramer-Douglas-Peucker Algorithm (https://github.com/fhirschmann/rdp) for optimize output (Default=-1: <0 for no-optimize; 0 for removal-duplicates-values and no-optimize; >0 for optimize, sample=0.001)")
    ...
    print("           " + __AppName__ + " ../tst/aixm4.5_SIA-FR_2020-04-23.xml " + aixmReader.CONST.frmtALL + " " + aixmReader.CONST.typeAIRSPACES + " " + aixmReader.CONST.optFreeFlight + " " + aixmReader.CONST.optOpenairDigitOptimize + "=0 " + aixmReader.CONST.optEpsilonReduce + "=0.001 " + aixmReader.CONST.optCleanLog)
    print("")
    print("  Resources")
